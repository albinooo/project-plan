        ...
        <div class="p-4 sm:ml-64">
            ...
            <div class="flex pt-4">
                <div class="w-3/12 relative flex flex-col shadow-lg mb-6 rounded-lg p-4 mr-4">
                    <span class="font-poppins font-semibold text-gray-500">Total Project</span>
                    {{-- <span class="font-poppins font-bold text-white text-2xl p-2 text-center">{{ $totalProjects }}</span> --}}
                </div>
            </div>
        </div>
    </body>
