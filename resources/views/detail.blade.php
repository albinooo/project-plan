    ...
    <body>
        ...
        <div class="p-4 sm:ml-64">
            ...
            <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 mt-5">
                ...
                <h4 class="text-lg font-semibold">{{ $task->task }}</h4> 
                ...
                <div class="w-full">
                    <p class="mb-1 font-normal text-gray-700 dark:text-gray-400">{{ $task->desc }}</p>
                    <p class="mb-1 font-normal text-gray-700 dark:text-gray-400">{{ $task->date }}</p>
                </div>
            </div>
            @endforeach
        </div>
