    ...
    <div>
        ...
        <div id="logo-sidebar"
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-[#00B4FE] dark:bg-gray-800">
                ...
                <div class="pb-4 mt-3">
                    <button type="button" class="flex items-center justify-between w-full px-4 py-3 text-sm font-medium text-white hover:text-[#00B4FE] transition-all duration-200 rounded-lg hover:bg-white">
        ...
        <div class="p-4 sm:ml-64">
            <nav class="bg-white border-gray-200 dark:bg-gray-900 z-20 top-0 start-0 border-b  dark:border-gray-600">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                    <span class="self-center text-2xl whitespace-nowrap dark:text-white text font-bold">Edit</span>
                    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <button type="button"
                            class="text-white bg-[#00B4FE] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah
                            Project</button>
            ...
            <div class="min-h-screen bg-white flex">
                <div class="h-screen w-full p-2">
                    <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
                        <div class="p-2">
                            <h2 class="text-lg font-poppins font-bold"><span>Edit Project</span></h2>
                        </div>
                        <div class="flex">
                            <a href="{{ url()->previous() }}">
                                <button
                        ...
                        <form action="tasks/edit" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="flex w-full">
                                        <div class="mt-3 w-1/2">
                                            <div class="w-full flex border-solid border rounded-lg">
                                                ...
                                                <div class="w-8/12 p-2 rounded-l-lg">
                                                    <input class="h-full w-full outline-none font-poppins" type="text" name="nama">
                                                </div>
                                            </div>
                                            <div class="w-full flex border-solid border rounded-lg mt-2">
                                                ...
                                                <div class="w-8/12 p-2 rounded-l-lg">
                                                    <input class="h-full w-full outline-none font-poppins" type="text" name="tanggal">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ml-2 mt-1 w-1/2">
                                            <div class="w-full flex border-solid border rounded-lg mt-2">
                                                ...
                                                <div class="w-8/12 p-2 rounded-l-lg">
                                                    <input class="h-full w-full outline-none font-poppins" type="text" name="deskripsi">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
