        ...
        <div class="p-4 sm:ml-64">
            <nav class="bg-white border-gray-200 dark:bg-gray-900 z-20 top-0 start-0 border-b dark:border-gray-600">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                    <span
                        class="self-center text-2xl whitespace-nowrap dark:text-white text font-bold p-4">Project</span>
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                @foreach ($projects as $project)
                    <div
                        class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 mt-5">
